...
from src.high_level_mgcbs_a2 import MGCBSSolverA2
from src.types_common import GridPos
from src.metrics import SearchMetrics
from src.visualization import visualize_paths_per_timestep
...
if __name__ == "__main__":
    ...
    print("walls:", grid.get_walls())
    print("shelves:", grid.get_shelves())
    print("stations:", grid.get_stations())
    print("dockings:", grid.get_docking_stations())
